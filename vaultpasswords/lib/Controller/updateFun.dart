...
class Updatefun {
  Future<bool> updateByID(String link,String name,String password,String id) async {
     try{
      // print(id + " : " + link + " : " + name + " : " + password);
      ...
      if (response.statusCode == 200) {
        ...
        throw new Exception('Error occured in update controller' + e.toString());
      }
  }
}